...
func (x *AdminResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AdminRequest) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\rAdminResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\")\n" +
	"\fAdminRequest\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xa7\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x16.auth.RegisterResponse\x1a\x15.auth.RegisterRequest\x120\n" +
	"\x05Login\x12\x13.auth.LoginResponse\x1a\x12.auth.LoginRequest\x122\n" +
	"\aIsAdmin\x12\x13.auth.AdminResponse\x1a\x12.auth.AdminRequestB\tZ\a.;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*AdminResponse)(nil),    // 4: auth.AdminResponse
	(*AdminRequest)(nil),     // 5: auth.AdminRequest
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterResponse
	2, // 1: auth.Auth.Login:input_type -> auth.LoginResponse
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.AdminResponse
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterRequest
	3, // 4: auth.Auth.Login:output_type -> auth.LoginRequest
	5, // 5: auth.Auth.IsAdmin:output_type -> auth.AdminRequest
